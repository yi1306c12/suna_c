...
AGENTS=agents/Unified_Neural_Model.cpp ${NEAT_AGENT}#agents/Mysterious_Agent.cpp agents/Dummy.cpp
NEAT_AGENT=agents/NEAT_Interface.cpp agents/neat/neat.cpp agents/neat/network.cpp agents/neat/nnode.cpp agents/neat/link.cpp agents/neat/trait.cpp agents/neat/gene.cpp agents/neat/genome.cpp agents/neat/innovation.cpp agents/neat/organism.cpp agents/neat/species.cpp agents/neat/population.cpp agents/neat/experiments.cpp 
...
main:
	g++ $(CFLAGS) $(MAIN_REINFORCEMENT_LEARNING) $(NEAT_AGENT) $(MAPS) $(ENVIRONMENTS) $(LDFLAGS) -o rl
