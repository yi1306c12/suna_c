...
void Neural_XCSF::printToFile(int match_set_size)
{
	...
	fprintf(fp,"%d %d %d %d %d\n",trial_counter, step_counter, match_set_size, previous_action_set[0], new_individual);
}
...
void Frog_Neural_XCSF::saveAgent(const char* filename)
{
	printf("saveAgent() not implemented\n");

}

void Frog_Neural_XCSF::loadAgent(const char* filename)
{
