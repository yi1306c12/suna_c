...
public class XCSFUtils {
	 ...
	 * 
	 * @param srcMatrix
	 *            the source quadratic matrix of size <code>n</code> *
	 *            <code>n</code>.
	 * @param srcVector
	 *            the source vector of length <code>n</code>.
	 * @param destination
	 *            the destination vector of length <code>n</code>.
	 * @param n
	 ...
	 * 
	 * @param srcMatrixExt
	 *            the extended source quadratic matrix of size <code>n+1</code> *
	 *            <code>n+1</code>.
	 * @param srcVector
	 *            the source vector of length <code>n</code>.
	 * @param destination
	 ...
	 * 
	 * @param srcA
	 *            the first quadratic source matrix of size <code>n</code> *
	 *            <code>n</code>.
	 * @param srcB
	 *            the second quadratic source matrix of size <code>n</code> *
	 *            <code>n</code>.
	 * @param destination
	 *            the quadratic destination matrix of size <code>n</code> *
	 *            <code>n</code>.
	 * @param n
	 *            the size of the arrays to be multiplied.
	 */
	 ...
	 * 
	 * @param source
	 *            quadratic source matrix of size <code>n</code> <code>n</code>.
	 * @param destination
	 *            quadratic destination matrix of size <code>n</code>*
	 *            <code>n</code>.
	 * @param n
	 *            the size of the arrays to be multiplied.
	 */
	 ...
	 * @see ConditionHyperellipsoid#getActivity(double[])
	 * @see RLSPrediction#predict(double[] predInput)
	 */
	 ...
	 * gnuplot.writeln(&quot;set title '2D Sine Function'&quot;);
	...
	public static class GnuPlotConsole {
		 ...
		 */
		public static String gnuPlotExecutable = null;
		...
		private final static String[][] EXECUTABLE = { { "Linux", "gnuplot" }, //
				{ "Windows", "C:/Programme/gnuplot/bin/pgnuplot.exe" } //
		};
