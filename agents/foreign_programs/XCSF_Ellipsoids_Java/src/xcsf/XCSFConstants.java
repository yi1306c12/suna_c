...
public class XCSFConstants {
	 ...
	 * runs.
	 */
	public static boolean doWriteOutput = false;

	/**
	 * If the final popualtion should be written out after each run.
	 */
	public static boolean doWritePopulation = false;
	...
	/**
	 * The learning rate for updating the prediction. Default: .1
	 */
	 ...
	 */
	public static int startCompaction = 90000;
	 ...
	 */
	public static int compactionType = 3;
	 ...
	 */
	public static int resetRLSPredictionsAfterSteps = startCompaction;
	...
	public static void load(String filename) throws IOException {
		...
		if (val != null)
			doWritePopulation = Boolean.valueOf(val).booleanValue();
		val = getProperty(prop, "doWriteOutput");
		if (val != null)
			doWriteOutput = Boolean.valueOf(val).booleanValue();
		...
		val = getProperty(prop, "eta");
		if (val != null)
			eta = Double.parseDouble(val);
		...
		if (val != null)
			doNumClosestMatch = Boolean.valueOf(val).booleanValue();
		...
		if (val != null)
			doGASubsumption = Boolean.valueOf(val).booleanValue();
		...
		if (val != null)
			doRandomize = Boolean.valueOf(val).booleanValue();
	}
