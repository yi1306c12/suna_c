...
/**
 * Implements a time-consuming listener to visualized the current prediction of
 * xcsf. GnuPlot is used to plot the 3D graph.
 * 
 * @see xcsf.XCSFUtils.GnuPlotConsole
...
public class PredictionVis implements XCSFListener {
	...
	public void stateChanged(int iteration, Classifier[] population,
		...
		if (iteration % ConditionVis.visualizationSteps != 0
