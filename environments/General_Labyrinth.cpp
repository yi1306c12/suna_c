...
#include"General_Labyrinth.h"

General_Labyrinth::General_Labyrinth(int trials_to_change_maze_states, Random* random)
{
...
General_Labyrinth::~General_Labyrinth()
{
	free(observation);
...
void General_Labyrinth::start(int &number_of_observation_vars, int& number_of_action_vars)
{
...
double General_Labyrinth::step(double* action)
{
	int i;
...
double General_Labyrinth::restart()
{
	step_counter=0;
	trial++;
...
void General_Labyrinth::printAgentBehavior(Reinforcement_Agent* agent)
{
	int i,j,k;
...
void General_Labyrinth::convertMap(int state)
{
...
void General_Labyrinth::printTrajectory(FILE* fp, double* observation, int size)
{
	int i;
